...
int main () {
  ...
  Date d1(2020, 1, 1, 3, 4);
  Date d2(2020, 1, 2, 3, 4);
  testDate(d1, d2, false);


  Date d3(2020, 6, 5, 1, 1);
  Date d4(2020, 6, 5, 6, 6);
  testDate(d3, d4, false);

  Date d5(2020, 6, 5, 7, 1);
  Date d6(2020, 6, 5, 8, 3);
  testDate(d5, d6, false);

  Date d7(2020, 6, 5, 10, 3);
  Date d8(2020, 6, 5, 11, 1);
  testDate(d7, d8, true);


  Date d9(2020, 6, 5, 6, 1);
  Date d10(2020, 6, 5, 6, 6);
